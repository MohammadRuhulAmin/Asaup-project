...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      <h1 class="logo mr-auto"><a href="">Asauper</a></h1>
...
{{--    mycode--}}
 ...
 <!-- end service-->
    ...
    <section id="cta" class="cta">
      <div class="container" data-aos="zoom-in">
        ...
        <div class="text-center">
          ...
          <br>
          <h1 class="text-white">01403288711</h1>
        </div>
  ...
  <footer id="footer">
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong><span>ASAUPER</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
